 ...
 *  The #defines below are structural sizing (hardware, MIDI timings, display smoothing), not
 *  algorithm parameters meant to be tuned.
 *
 *  The per-note calibration (real measured fundamental, "stretched" tuning of acoustic pianos)
 *  is kept as is, persisted in NVS (namespace "plmic").
 *
 *  Public API unchanged: micBegin / micRunning / micEvents / micSetGain / micSetThreshold /
 *  micGetStatus / micArmCal / micClearCal / micCalFreq / micCalCount.
 * ==================================================================================================
 */
#pragma once
